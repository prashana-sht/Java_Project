...
public class DML {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            insertRecord(connection, "Ram", "Khatri", 25);
            
            insertRecord(connection, "Shyam", "Khadka", 22);


            updateRecord(connection, 6, "Judy");
    ...
    private static void insertRecord(Connection connection, String firstName, String lastName, int age) 
            throws SQLException {
    ...
    private static void updateRecord(Connection connection, int id, String newFirstName) 
            throws SQLException {
